...
export default function TradingInsights() {
  ...
  if (loading) return <Surface className="flex justify-center py-20" role="status"><Loader2 className="h-7 w-7 animate-spin text-emerald-700" aria-hidden="true" /><span className="sr-only">Memuat review trading</span></Surface>;
