...
export function EmptyState({ icon: Icon, title, description, action }: {
  ...
  return (
    <div className="px-5 py-12 text-center sm:px-6 sm:py-20">
      <span className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl border border-emerald-100 bg-emerald-50 text-emerald-700 shadow-[var(--shadow-control)]">
