...
export function EmptyState({ icon: Icon, title, description, action }: {
  ...
  return (
    <div className="px-5 py-12 text-center sm:px-6 sm:py-20">
      ...
      <h2 className="mt-4 text-[17px] font-bold tracking-[-0.025em] text-slate-900 sm:text-lg">{title}</h2>
      <p className="mx-auto mt-2 max-w-md text-[13px] leading-5 text-slate-500 sm:text-sm sm:leading-6">{description}</p>
