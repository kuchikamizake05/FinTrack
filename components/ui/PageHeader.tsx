  ...
  return (
    <header className="flex flex-col gap-4 pt-1 sm:flex-row sm:items-end sm:justify-between sm:gap-5 sm:pt-0">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-3 text-[1.75rem] font-bold leading-[1.06] tracking-[-0.045em] text-slate-900 sm:mt-0 sm:text-4xl">{title}</h1>
        <p className="mt-2 max-w-xl text-[13px] leading-5 text-slate-500 sm:text-sm sm:leading-6">{description}</p>
      </div>
      {actions && (
